...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateUser(CreateUserCommandRequest creteUserCommandRequest)
        {
            CreateUserCommandResponse response = await _mediator.Send(creteUserCommandRequest);
            return Ok(response);
        }
